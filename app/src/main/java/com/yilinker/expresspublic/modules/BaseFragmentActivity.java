...
{
    private static final Logger logger = Logger.getLogger(BaseFragmentActivity.class.getSimpleName());
...
//                        return true;
        ...
        tv_logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CommonPrefHelper.clearCommon(BaseFragmentActivity.this);
                OAuthPrefHelper.clearOAuth(BaseFragmentActivity.this);
                UserPrefHelper.clearUser(BaseFragmentActivity.this);
