 ...
 */
public class AccessGsonRequest<T> extends Request<T>
{
    private static final Logger logger = Logger.getLogger(AccessGsonRequest.class.getSimpleName());
     ...
     */
    private final AccessGsonResponseListener<T> listener;

    /**
     * Listener when a response is received
     * @param <T> type of response
     */
    public interface AccessGsonResponseListener<T>
    {
     ...
     * @param errorListener
     */
    public AccessGsonRequest(int method, String url, Map<String, String> params, Class<T> clazz, AccessGsonResponseListener<T> listener,
